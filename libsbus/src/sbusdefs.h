...
*/
/** @file defs.h
   @brief Definiciones comunes de la biblioteca
...
#define SBUS_VERSION "0.2.0"

/// System message tag "Ma'Name Is"
#define SBUS_MANAMEIS  -1

/// System message tag "Name was taken"
#define SBUS_NAMETAKEN -2
